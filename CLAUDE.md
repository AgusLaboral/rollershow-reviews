...
- **Sin roller decorativo persistente**: junto a chances/puntos no vive ningún tubo, cadena ni imitación 3D. Agus rechazó incluso la versión full width porque seguía pareciendo un objeto de videojuego y competía con el contenido. La cortina roller existe sólo durante el cambio de etapa: la tela sunscreen baja desde el borde superior del área de contenido, cubre y revela. Si se incorpora un mecanismo visible en reposo, debe partir de un asset real aprobado; no recrearlo con gradientes CSS.
