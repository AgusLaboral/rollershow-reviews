...
- **Paños finales sunscreen con materialidad visible**: los cinco paños de `.gr-curtain-reveal` conservan el ambiente, pero no pueden parecer una gasa invisible. Usan alfa cercano a `.70`, malla bidireccional, fibra irregular, variación de luz y un `backdrop-filter` controlado de 5 px que desenfoca el ambiente mientras se levantan. No llevar el blur al roller de transición general ni convertir estos paños en vidrio frost; la textura tejida debe seguir dominando.
