...
- **La recompensa acompaña la decisión**: toda acción que agrega material nuevo recuerda el valor exacto en su propia etiqueta cuando el dato ya no está visible al lado: foto `+10 puntos`, video `+25`, audio `+30`, calificación `+5` y texto `+5`. No repetir puntos en botones que sólo avanzan, reemplazan o revisan contenido.
