...
- **Un solo recorrido oficial**: se eliminó la variante vertical porque la cortina dominaba la lectura y la diferencia no era comprensible. El recorrido canónico usa profundidad y escala debajo del gesto principal.
- **Cortina roller sunscreen, no telón teatral**: el cambio de paso debe tener un gesto inequívoco de producto. Una trama sunscreen translúcida baja, refracta el ambiente, lo cubre y revela la etapa siguiente; evitar pliegues, terciopelo o teatralidad cursi.
